...
def getPick3Data():
    ...
    data = filterByDateRange(data, '2023-12-01', date.today().strftime('%Y-%m-%d')) # Read only specific data range
...
def analyseData():
    ...
    data = filterByDateRange(data, '2023-05-01', '2023-12-31') # To analyse specific data range
